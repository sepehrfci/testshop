    ...
    <div id="ctn-preloader" class="ont-preloader">
        <div class="animation-preloader">
            ...
            <div class="txt-loading">
                    <span data-text-preloader="تست شاپ" class="letters-loading">
                        تست شاپ
                     </span>
            </div>
        ...
        <header class="top-header-area d-flex align-items-center justify-content-between">
            <div class="left-side-content-area d-flex align-items-center">
                ...
                <div class="mobile-logo mr-3 mr-sm-4">
                    <a href="index-2.html"><img src="/admin/img/core-img/small-logo.png" alt="آرم موبایل"></a>
                </div>
            ...
            <div class="right-side-navbar d-flex align-items-center justify-content-end">
                ...
                <ul class="right-side-content d-flex align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/admin/img/member-img/3.png" alt=""></button>
                        <div class="dropdown-menu dropdown-menu-right">
                            <!-- User Profile Area -->
                            <div class="user-profile-area">
                                ...
                                <a href="#" class="dropdown-item"><i class="ti-unlink profile-icon bg-warning" aria-hidden="true"></i> خروج از سیستم</a>
                            </div>
                        </div>
                    </li>
                </ul>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="dashboard-content-left wow shake" data-wow-delay="0.6s">
                                            <img src="/admin/img/bg-img/5.jpg" class="img-fluid" alt="داشبورد" width="180" height="180">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <table class="table table-hover">
                                                    ...
                                                    <td>
                                                        <div class="media align-items-center">
                                                            <div class="chat-img mr-2">
                                                                <img src="/admin/img/shop-img/best-4.png" alt="">
                                                            </div>
                                                            <div>
                                                                <span>تلفن تلفن</span>
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center">
                                                            <div class="chat-img mr-2">
                                                                <img src="/admin/img/shop-img/best-3.png" alt="">
                                                            </div>
                                                            <div>
                                                                <span>ساعت مچی</span>
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center">
                                                            <div class="chat-img mr-2">
                                                                <img src="/admin/img/shop-img/best-2.png" alt="">
                                                            </div>
                                                            <div>
                                        ...
                                        <div class="tab-pane fade" id="today-users" role="tabpanel" aria-labelledby="today-users-tab">
                                            <ul class="total-earnings-list">
                                                ...
                                                <li>
                                                    <div class="author-info d-flex align-items-center">
                                                        <div class="author-img mr-3">
                                                            <img src="/admin/img/member-img/team-3.jpg" alt="">
                                                        </div>
                                                        <div class="author-text">
                                                ...
                                                <li>
                                                    <div class="author-info d-flex align-items-center">
                                                        <div class="author-img mr-3">
                                                            <img src="/admin/img/member-img/team-4.jpg" alt="">
                                                        </div>
                                                        <div class="author-text">
                                                ...
                                                <li>
                                                    <div class="author-info d-flex align-items-center">
                                                        <div class="author-img mr-3">
                                                            <img src="/admin/img/member-img/team-5.jpg" alt="">
                                                        </div>
                                                        <div class="author-text">
                                                ...
                                                <li>
                                                    <div class="author-info d-flex align-items-center">
                                                        <div class="author-img mr-3">
                                                            <img src="/admin/img/member-img/team-7.jpg" alt="">
                                                        </div>
                                                        <div class="author-text">
                                                            <h6 class="mb-0">ویلتور دلتون</h6>
                                                            <p class="mb-0">مدیر پروژه</p>
                                        ...
                                        <div class="tab-pane fade active show" id="month-users" role="tabpanel" aria-labelledby="month-users-tab">
                                            <ul class="total-earnings-list">
                                                <li>
                                                    <div class="author-info d-flex align-items-center">
                                                        <div class="author-img mr-3">
                                                            <img src="/admin/img/member-img/2.png" alt="">
                                                        </div>
                                                        <div class="author-text">
                                                            <h6 class="mb-0">ویلتور دلتون</h6>
                                                            <p class="mb-0">مدیر پروژه</p>
                                                ...
                                                <li>
                                                    <div class="author-info d-flex align-items-center">
                                                        <div class="author-img mr-3">
                                                            <img src="/admin/img/member-img/3.png" alt="">
                                                        </div>
                                                        <div class="author-text">
                                                            <h6 class="mb-0">نام کاربر</h6>
                                                            <p class="mb-0">طراح محصول</p>
                                                ...
                                                <li>
                                                    <div class="author-info d-flex align-items-center">
                                                        <div class="author-img mr-3">
                                                            <img src="/admin/img/member-img/4.png" alt="">
                                                        </div>
                                                        <div class="author-text">
                                                            <h6 class="mb-0">دیسک نیلی</h6>
                                                            <p class="mb-0">توسعه دهنده وب</p>
                                                ...
                                                <li>
                                                    <div class="author-info d-flex align-items-center">
                                                        <div class="author-img mr-3">
                                                            <img src="/admin/img/member-img/5.png" alt="">
                                                        </div>
                                                        <div class="author-text">
                                                            <h6 class="mb-0">نیک استون</h6>
                                                            <p class="mb-0">طراح ویژوال</p>
                                            ...
                                            <div class="single-widget-timeline mb-15">
                                                <div class="media">
                                                    <div class="mr-3">
                                                        ...
                                                        <a href="#!"><img class="rounded-circle" style="width:40px;" src="/admin/img/member-img/1.png" alt="کاربر چت"></a>
                                                    </div>
                                                    <div class="media-body">
                                        ...
                                        <div class="col-12">
                                            <div class="single-widget-timeline mb-15">
                                                <div class="media">
                                                    <div class="mr-3">
                                                        <i class="fa fa-circle text-success font-11 mr-2"></i>
                                                        <a href="#!"><img class="rounded-circle" style="width:40px;" src="/admin/img/member-img/team-1.jpg" alt="کاربر چت"></a>
                                                    </div>
                                                    <div class="media-body">
                                                        <h6 class="d-inline-block">لورم ایپسوم متن ساختگی  </h6>
                                        ...
                                        <div class="col-12">
                                            <div class="single-widget-timeline mb-15">
                                                <div class="media">
                                                    <div class="mr-3">
                                                        <i class="fa fa-circle text-success font-11 mr-2"></i>
                                                        <a href="#!"><img class="rounded-circle" style="width:40px;" src="/admin/img/member-img/team-2.jpg" alt="کاربر چت"></a>
                                                    </div>
                                                    <div class="media-body">
                                                        <h6 class="d-inline-block">لورم ایپسوم متن ساختگی  </h6>
                                                        <p class="mb-0">لورم ایپسوم متن ساده ای است ...</p>
                                        ...
                                        <div class="col-12">
                                            <div class="single-widget-timeline">
                                                <div class="media">
                                                    <div class="mr-3">
                                                        <i class="fa fa-circle text-success font-11 mr-2"></i>
                                                        <a href="#!"><img class="rounded-circle" style="width:40px;" src="/admin/img/member-img/team-4.jpg" alt="کاربر چت"></a>
                                                    </div>
                                                    <div class="media-body">
                                                        <h6 class="d-inline-block">لورم ایپسوم متن ساختگی  </h6>
                                        ...
                                        <div class="chats" id="chatBox">
                                            <div class="chats">
                                                <div class="chat">
                                                    <div class="chat-avatar">
                                                        <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                                                            <img src="/admin/img/member-img/1.png" alt="آواتار">
                                                        </a>
                                                    </div>
                                                    <div class="chat-body">
                                                ...
                                                <div class="chat chat-left">
                                                    <div class="chat-avatar">
                                                        <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
                                                            <img src="/admin/img/member-img/2.png" alt="آواتار">
                                                        </a>
                                                    </div>
                                                    <div class="chat-body">
                                                        <div class="chat-content">
                                                ...
                                                <div class="chat">
                                                    <div class="chat-avatar">
                                                        <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                                                            <img src="/admin/img/member-img/3.png" alt="آواتار">
                                                        </a>
                                                    </div>
                                                    <div class="chat-body">
                                                        <div class="chat-content">
                                                ...
                                                <div class="chat chat-left">
                                                    <div class="chat-avatar">
                                                        <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
                                                            <img src="/admin/img/member-img/4.png" alt="آواتار">
                                                        </a>
                                                    </div>
                                                    <div class="chat-body">
                                                        <div class="chat-content">
                                                ...
                                                <div class="chat">
                                                    <div class="chat-avatar">
                                                        <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                                                            <img src="/admin/img/member-img/5.png" alt="آواتار">
                                                        </a>
                                                    </div>
                                                    <div class="chat-body">
                                                        <div class="chat-content">
                                                ...
                                                <div class="chat chat-left">
                                                    <div class="chat-avatar">
                                                        <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
                                                            <img src="/admin/img/member-img/6.png" alt="آواتار">
                                                        </a>
                                                    </div>
                                                    <div class="chat-body">
                                                        <div class="chat-content">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="widget-download-file d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center mr-3">
                                            <div class="download-file-icon mr-3">
                                                <img src="/admin/img/filemanager-img/1.png" alt="">
                                            </div>
                                    ...
                                    <div class="widget-download-file d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center mr-3">
                                            <div class="download-file-icon mr-3">
                                                <img src="/admin/img/filemanager-img/5.png" alt="">
                                            </div>
                                            <div class="user-text-table">
                                    ...
                                    <div class="widget-download-file d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center mr-3">
                                            <div class="download-file-icon mr-3">
                                                <img src="/admin/img/filemanager-img/6.png" alt="">
                                            </div>
                                            <div class="user-text-table">
                                    ...
                                    <div class="widget-download-file d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center mr-3">
                                            <div class="download-file-icon mr-3">
                                                <img src="/admin/img/filemanager-img/7.png" alt="">
                                            </div>
                                            <div class="user-text-table">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <div class="user-card-body">
                                        <div class="client-media-content d-flex align-items-center mb-4">
                                            <img class="client-thumb rounded-circle mr-3" src="/admin/img/member-img/contact-1.jpg" alt="">
                                        ...
                                        <div class="client-media-content d-flex align-items-center mb-4">
                                            <img class="client-thumb rounded-circle mr-3" src="/admin/img/member-img/contact-2.jpg" alt="">
                                            <div class="user--media-body">
                                        ...
                                        <div class="client-media-content d-flex align-items-center mb-4">
                                            <img class="client-thumb rounded-circle mr-3" src="/admin/img/member-img/contact-3.jpg" alt="">
                                            <div class="user--media-body">
                                        ...
                                        <div class="client-media-content d-flex align-items-center mb-4">
                                            <img class="client-thumb rounded-circle mr-3" src="/admin/img/member-img/contact-4.jpg" alt="">
                                            <div class="user--media-body">
